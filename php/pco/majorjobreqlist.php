...
<div class="sidebar">
        ...
        <ul class="nav_list">
            <li>
                <a href="../../../../php/pco/pcodashboard.php">
            ...
            <li>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="../../../../php/pco/jobrequest/minor/minorjobreqlist.php">Minor Job Request</a>
                        <a class="dropdown-item" href="../../../../php/pco/jobrequest/major/majorjobreqlist.php">Major Job Request</a>
                    </ul>
                </div>
            </li>
            <li>
                <a href="../../../../php/pco/pcoreservation/pcoreservation.php">
        ...
        <div class="profile_content">
                <div class="profile">
                    ...
                    <img src="../../../../images/ico/profileicon.png" alt="" style = "height: 45px; width:45px; object-fit:cover; border-radius:12px;" />
                        <div class="name_role">
                            <div class="name">PCO</div>
                            <div class="role">PCO</div>
                        </div>
                    </div>
                    <a href="../../../../logout.php">
        ...
        <div class="modal-dialog" style="max-width:1000px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="exampleModalLabel">Major Job Request Form</h5>
