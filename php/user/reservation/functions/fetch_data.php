...
while ($row = mysqli_fetch_assoc($run_query)) {
    ...
    $subarray[] = $row['status'];
    $subarray[] = '<a href= "javascript:void();" data-id="' . $row['reservationid'] . '" class ="btn btn-sm btn-info editBtn">More Info</a> <a href= "javascript:void();" data-id="' . $row['reservationid'] . '" class ="btn btn-sm btn-danger btnDelete">Delete</a>';
    $data[] = $subarray;
}
