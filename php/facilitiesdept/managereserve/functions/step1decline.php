...
$message = "Facilities Department declined your Reservation Request with Request no: ".$id."!\nYou can check your request status at Reservation Section.";
$message2 = "You successfully declined a Reservation Request from ".$dept." with Request No. ".$id."";
$sql = "UPDATE `reservation` SET `fdstatus` = 'Declined', `status` = 'Declined', `feedback` = '$feedb' WHERE reservationid = '$id'";
...
if ($query == true) {
    ...
    $sqlnotif2 = "INSERT INTO `notif_data` (`message`, `department`, `created_at`, `is_read`) VALUES ('$message2', 'Facilities Department', '$formatted_date','0')";
