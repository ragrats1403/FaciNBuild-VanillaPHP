...
$sql = "select * FROM majoreq WHERE pcostatus = 'Approved'";
$query = mysqli_query($con, $sql);
$count_all_rows = mysqli_num_rows($query);

if (isset($_POST['search']['value'])) {
    $search_value = $_POST['search']['value'];
    $sql .= " OR jobreqno like '%" . $search_value . "%' AND pcostatus = 'Approved' ";
    $sql .= " OR requino like '%" . $search_value . "%' AND pcostatus = 'Approved' ";
    $sql .= " OR status like '%" . $search_value . "%' AND pcostatus = 'Approved' ";
    $sql .= " OR department like '%" . $search_value . "%' AND pcostatus = 'Approved' ";
}
