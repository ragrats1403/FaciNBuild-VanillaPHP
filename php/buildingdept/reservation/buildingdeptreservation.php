                ...
                <div class="modal-body ">
                    <form action="">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" onclick="myFunction('myDIV1')">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    <form action="">
                        ...
                        <div class="col-md-6 ">
                            <label class="fw-bold" for="date">Requesting Party:</label>
                            <input type="name" class="form-control input-sm col-xs-1" id="reqparty" placeholder="Building Department" disabled>
                        </div>
                        <div class="justify-content-center">
                            <div class="col-md-12">
                                <label class="fw-bold" for="date">Purpose of Activity:</label>
                        ...
                        <!-- ADD ON SECTION-->
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" onclick="myFunction('myDIV2')">
                            <label class="form-check-label" for="flexCheckDefault"> Add-on </label>
                        </div>
